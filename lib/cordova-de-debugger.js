...
export default {
  ...
  openPushTool(){
    ...
    var projectManagementView = require("./pushtool/pushtool-view");
  ...
  getPushToolRouteConfig(){
    var config ={};
    var sendPushView=require("./plugins/plugins-view");
    var pushConfigView=require("./plugins/plugin-install-view");
    // add import and new of your controller here
    var SendPushViewUIHandler =require("./variants/VariantsViewUIHandler");
    var PushConfigViewUIHandler = require("./plugins/PluginInstallViewUIHandler");

    config["PushConfigPanel"] = {
      menuId:"PushConfigMenuItem",
      view: pluginView,
      controller: new PushConfigUIHandler()
    }
    config["SendPushPanel"] = {
      menuId: "SendPushMenuItem",
      view: pluginInstallView,
      controller: new SendPushUIHandler()
    }
    return config;
  },
  **/
