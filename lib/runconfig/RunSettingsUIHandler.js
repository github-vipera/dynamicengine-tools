...
export default class RunSettingsUIHandler {
  ...
  initVariantSelect(){
    ...
    this.variantsHandler.load().then(() => {
      ...
      if(this.currentSelection.variant){
        this.selectRef.val(this.currentSelection.variant);
      }
    },(err) => {
  ...
  bindJS(){
    ...
    */
    ...
    /**
     * Setup change of variants
     */
    $('#derunsettings-variant-select').off('change').on('change',() => {
      console.log("Change of variant to",this.selectRef.val())
      this.currentSelection.variant=this.selectRef.val();
    });
  ...
  unbindJS(){
    ...
    $('#derunsettings-variant-select').off('change');
