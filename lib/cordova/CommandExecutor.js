...
export default class CommandExecutor {
  ...
  createNewProjectWithSpawn(projectInfo){
    console.log("Creatine new project with spawn for ",projectInfo);
    var cmd="cordova"
    var args = ["create",projectInfo.path, projectInfo.packageId, projectInfo.name];
    var options=this.getCmdOptions();
