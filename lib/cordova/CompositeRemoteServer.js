...
export default class CompositeRemoteServer {
  ...
  defaultInit(){
    var androidPort = parseInt(atom.config.get('cordova-de-debugger.androidRunPort'));
    var iosPort = parseInt(atom.config.get('cordova-de-debugger.iOSRunPort'));
  ...
  startServer(config){
    ...
    var browserPort = parseInt(atom.config.get('cordova-de-debugger.browserRunPort'));
