...
export default class SendPushViewUIHandler {
  ...
  sendPush(){
      ...
      /**
      var platformSelectors = $('button[push-platform-select]').wrappAll();
      for (i=0;i<platformSelectors.length;i++){
      ...
      **/
      var useAndroid = $('#sel-platform-android').hasClass('selected');
      var useIOS = $('#sel-platform-ios').hasClass('selected');
      var platform = '';
