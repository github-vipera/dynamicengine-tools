        ...
        <img class="va-white-logo" src="atom://dynamicengine-debugger/resources/VA_white.png" style="position:absolute;opacity:0.05;top:-5px;right:-4px;height:50px;">
            ...
            <section class="section">
              ...
              <div class='block' style="margin-top:20px;">
                ...
                <label class='input-label' style='padding-left:0px;'><input class='input-checkbox' type='checkbox' style='padding-right:4px;' checked>Android </label>
                <label class='input-label' style='padding-left:10px;'><input class='input-checkbox' type='checkbox' style='padding-right:4px;' checked>iOS</label>
                <label class='input-label' style='padding-left:10px;'><input class='input-checkbox' type='checkbox' style='padding-right:4px;' checked>Browser</label>
              </div>
