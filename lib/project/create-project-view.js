...
module.exports = {
    render: function() {
        return `
        <img class="va-white-logo" src="atom://dynamicengine-tools/resources/VA_white.png" style="position:absolute;top:-5px;right:-4px;height:50px;">
              ...
              <div class='block'>
                <label style="display:block; padding-bottom:5px">Project Type</label>
                  <div class='btn-group'>
                      ...
                      <button class='btn' id="de-tools-cordova-project-ionic-2">Ionic 3 Framework</button>
                  </div>
              </div>
