    ...
    return `
      <atom-panel class='padded'>
        <div class="inset-panel" collapsable-name="scriptTools">
          <div class="panel-heading" collapsable-header-of="scriptTools"><span class='icon icon-settings'></span>Script setup<span class='text-subtle'>&nbsp;&nbsp;(NB: execute an npm install in your project folder before)</span></div>
