      ...
      <div class="section">
        <div class="section-container">
            ...
            <div class="block" show-for-offline>
             <button class='inline-block btn' style="vertical-align:top;" id='install-vipera-npm-registry'><span class='icon icon-repo-clone' style='padding-right:4px;'></span>Set Vipera SDK location</button>
             <div style="margin-top:8px;" class="text-subtle">Current NPM registry:&nbsp&nbsp<span class="inline-block highlight" id="current-npm-registry">Unknown</span></div>
            </div>
        </div>
      </div>
