              ...
              <div class="search-container clearfix">
                <div class="editor-container">
                 ...
                 <div class='block' style='padding-top:10px;'>
                     <div class='btn-group'>
                         <button class='btn selected platform-select' id='platform-select-android'><i class='fa fa-android' aria-hidden="true" style='padding-right:4px;'></i>Android</button>
                         <button class='btn platform-select' id='platform-select-ios'><i class='fa fa-apple' aria-hidden="true" style='padding-right:4px;'></i>iOS</button>
                         ...
                         <button class='btn platform-select' id='platform-select-browser'><i class='fa fa-chrome' aria-hidden="true" style='padding-right:4px;'></i>Browser</button>
                     </div>
                 </div>
