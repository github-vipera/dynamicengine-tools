...
export default class ProjectManagementUiHandler {
  ...
  initUI(){
    ...
    $('#IOSSigningMenuItem').bind('click', (evt) => {
        this.selectPanel('IOSSigningMenuItem');
    });

    $('#AndroidSigningMenuItem').bind('click', (evt) => {
        this.selectPanel('AndroidSigningMenuItem');
    });
  }
  ...
  selectPanel(panelId){
    ...
    $('#IOSSigningMenuItem').removeClass('menu-item-selected');
    $('#AndroidSigningMenuItem').removeClass('menu-item-selected');
