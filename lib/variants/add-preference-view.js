      ...
      return `
        <atom-panel class='padded'>
            <div class="block">
              ...
              <input class='input-text native-key-bindings' type='text' name="preference-name" id="txt-new-preference-name" placeholder='your Preference name'>
            </div>
            <div class="block">
              <label for="preference-name">Preference name</label>
              <input class='input-text native-key-bindings' type='text' name="preference-value" id="txt-new-preference-value" placeholder='your Preference value'>
            </div>
            <div class='block'>
