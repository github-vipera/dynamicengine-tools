        ...
        <atom-panel>
          <div class="inset-panel">
              ...
              <div class="panel-body padded">
                <div class="block">
                  <h3>Global settings</h3>
                  <button class='btn icon icon-plus inline-block-tight' variant-add-preference vairant-ref="{{name}}"></button>
                </div>
                <!-- Global -->
                {{#each preference}}
                  <div class="block">
                ...
                {{#each platform}}
                  ...
                  {{#each preference}}
                    <div class="block">
                      <label for={{name}}>{{name}}</label>
                      <input class='input-text native-key-bindings' type='text' name="{{name}}" variant-preference-platform-id="{{name}}" id="{{../../name}}-{{../name}}-{{name}}" placeholder='' value="{{value}}">
                    </div>
                  {{/each}}
                  <div class="line-div"></div>
                {{/each}}
